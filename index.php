    ...
    <div class="container">
        ...
        <div class="result__table table">
            <div class="table__col">
                ...
                <div class="table__cell table__cell--num">
                    <p class="table__text">1</p>
                </div>
                <div class="table__cell table__cell--num">
                    <p class="table__text">2</p>
                </div>
                <div class="table__cell table__cell--num">
                    <p class="table__text">3</p>
                </div>
                <div class="table__cell table__cell--num">
                    <p class="table__text">4</p>
                </div>
                <div class="table__cell table__cell--num">
            ...
            <div class="table__wrap js-table-slider">
                <div class="table__col">
                    ...
                    <div class="table__cell">
                        <p class="table__text">3 kg </p>
                    </div>
                    <div class="table__cell">
                        <p class="table__text">3 kg </p>
                    </div>
                    <div class="table__cell">
                        <p class="table__text">2 kg </p>
                    </div>
                    <div class="table__cell">
                        <p class="table__text">2 kg </p>
                    </div>
                    <div class="table__cell">
                        <p class="table__text">1 kg </p>
                    </div>
                    <div class="table__cell table__cell--result">
                        <p class="table__text">- 15 kg </p>
                    </div>
                </div>
                <div class="table__col">
                    <div class="table__cell table__cell--title">
...
<header class="header block bg" id="header">
    <div class="label js-label" data-target="#header"></div>
    <div class="container">
        <div class="header__wrapper">
            <div class="header__info">
                <h1 class="header__title blue">Turboslim</h1>
