...
(function () {
  ...
  var Controls = function () {
    ...
    var buttonOpenQuestion = document.querySelector(".question__button");
    var open = document.querySelector(".js-question-open");
    var close = document.querySelector(".js-question-close");
    var questionVissible = document.querySelectorAll(".js-question-vissible");
    var label = $(".js-label");
    return {
      openQuestion: function openQuestion() {
        buttonOpenQuestion.addEventListener("click", function () {
          ...
          for (var index = 0; index < questionVissible.length; index++) {
  ...
  var Sliders = function () {
    ...
    var reviewInfo = $(".js-info-review");
    var reviewBtn = $(".js-btn-review");
    return {
      initMobileReviewSlider: function initMobileReviewSlider() {
      ...
      destroyReviewSlider: function destroyReviewSlider() {
        $(".js-reviews-slider.slick-initialized").slick("unslick");
      },
      initMobileTableSlider: function initMobileTableSlider() {
        var _$$slick;

        $(".js-table-slider:not(.slick-initialized)").slick((_$$slick = {
          infinite: true,
          slidesToShow: 3,
          slidesToScroll: 3,
          variableWidth: true
      ...
      destroyTableSlider: function destroyTableSlider() {
        $(".js-table-slider.slick-initialized").slick("unslick");
      },
      showInfoReview: function showInfoReview() {
        reviewBtn.click(function (e) {
          e.preventDefault();

          var _this = $(this);

          var targetInfo = _this.prev(".js-info-review");
